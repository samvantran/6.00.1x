...
WORDLIST_FILENAME = "/Users/svt/Desktop/6.00.1x/ProblemSet4/words.txt"
...
def getWordScore(word, n):
    ...
    # iterate through word checking point value of each letter
    for l in word:
        wordScore += SCRABBLE_LETTER_VALUES[l]
    
    # calculate word score
    totalWordScore = wordScore * len(word)
